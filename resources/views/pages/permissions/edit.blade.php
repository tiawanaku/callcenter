                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-permission-holder" class=" ">
                                            <input id="ctrl-permission" data-field="permission"  value="<?php  echo $data['permission']; ?>" type="text" placeholder="Escribir Permission"  required="" name="permission"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
