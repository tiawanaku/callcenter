                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-role_name-holder" class=" ">
                                            <input id="ctrl-role_name" data-field="role_name"  value="<?php  echo $data['role_name']; ?>" type="text" placeholder="Escribir Role Name"  required="" name="role_name"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
